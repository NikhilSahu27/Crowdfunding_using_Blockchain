...
import { abi, contractAddress3 } from "./constants.js"
...
async function getBalance() {
    if (typeof window.ethereum != "undefined") {
        ...
        const balance = await provider.getBalance(contractAddress3)
...
function donorbutton() {
    ...
    async function fetchTransactions() {
        ...
        const url = `https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=${contractAddress3}&apikey=${apiKey}`
...
async function fund() {
    ...
    if (typeof window.ethereum !== "undefined") {
        ...
        const contract = new ethers.Contract(contractAddress3, abi, signer)
        try {
