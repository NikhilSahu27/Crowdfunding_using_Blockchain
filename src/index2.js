...
import { abi, contractAddress2 } from "./constants.js"
...
async function getBalance() {
    if (typeof window.ethereum != "undefined") {
        ...
        const balance = await provider.getBalance(contractAddress2)
...
function donorbutton() {
    ...
    async function fetchTransactions() {
        ...
        const url = `https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=${contractAddress2}&apikey=${apiKey}`
